...
public class AddInGoods extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_ingoods);// 设置布局文件
        txtInId=(EditText)findViewById(R.id.txtInId);
        txtInName=(EditText)findViewById(R.id.txtInName);
        txtInMoney = (EditText) findViewById(R.id.txtInMoney);// 获取金额文本框
        txtInMany=(EditText)findViewById(R.id.txtInMany);
            ...
            public void onClick(View arg0) {
                ...
                if (!strInId.isEmpty()) {// 判断金额不为空
                    ...
                    IngoodsDAO ingoodsDAO = new IngoodsDAO(
                            AddInGoods.this);
                    // 创建Tb_inaccount对象
                    Toast.makeText(AddInGoods.this, "开始创建数据操做类",
                            Toast.LENGTH_SHORT).show();
                    Tb_ingoods tb_ingoods = new Tb_ingoods(
                    ...
                    Toast.makeText(AddInGoods.this, "创建完成，准备插入数据裤",
                            Toast.LENGTH_SHORT).show();
                    ingoodsDAO.add(tb_ingoods);// 添加收入信息
                    // 弹出信息提示
                    Toast.makeText(AddInGoods.this, "〖新增进货信息〗添加成功！",
                            Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(AddInGoods.this,MainActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(AddInGoods.this, "请编号！",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
